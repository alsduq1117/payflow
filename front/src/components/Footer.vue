...
<template>
  <div class="text-center py-6 px-4 container mx-auto text-gray-500 text-sm mt-12">
    <div class="md:flex justify-between items-center">
      <div class="mb-4 md:mb-0">Designed and built with <span class="text-red-500">♥</span> by <a class="hover:underline text-gray-600" href="https://twitter.com/saleh_mirnezami">Saleh Mir</a>. Licensed under the MIT License.</div>
      ...
      <div class="flex justify-center">
        ...
        <div class="w-8 ml-2 text-gray-500">
          <a href="#" class="hover:text-gray-700">
            <svg xmslns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="fill-current">
              <path
